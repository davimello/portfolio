...
var utils_pick = require('./pick.js');

function isCSSProp(prop) {
  return Object.keys(cssProps).includes(prop);
}
function pickCSSProps(props) {
  return utils_pick.pick.apply(void 0, [props].concat(Object.keys(cssProps)));
}
function omitCSSProps(props) {
  return utils_omit.omit.apply(void 0, [props].concat(Object.keys(cssProps)));
}
var cssProps = {
  _hover: ':hover',
...
exports.omitCSSProps = omitCSSProps;
exports.pickCSSProps = pickCSSProps;
