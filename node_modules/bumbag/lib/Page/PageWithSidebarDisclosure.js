...
require('../Drawer.styles-084663ed.js');
...
var useProps = utils_createHook.createHook(function (props, _ref) {
  ...
  var htmlProps = Disclosure_index.Disclosure.useProps(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, props), page.isCollapsed ? page.sidebar.drawer : page.sidebar.disclosure));
  var className = utils_useClassName.useClassName({
    style: Page_Page_styles.PageWithSidebarDisclosure,
    styleProps: props,
    themeKey: themeKey,
...
var PageWithSidebarDisclosure = utils_createComponent.createComponent(function (props) {
