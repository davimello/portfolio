...
var useProps = utils_createHook.createHook(function (props, _ref4) {
  ...
  var debouncedInputValue = utils_useDebounce.useDebounce(inputValue, 500);
  ...
  return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, boxProps), {}, {
    ...
    children: /*#__PURE__*/React.createElement(AutosuggestContext.Provider, {
      ...
      variant: variant,
      value: inputValue
    })), /*#__PURE__*/React.createElement(DropdownMenu_DropdownMenuPopover.DropdownMenuPopover, _rollupPluginBabelHelpers._extends({}, dropdownMenu, {
      ref: popoverRef,
    ...
    }, popoverProps), dropdownMenu.visible && /*#__PURE__*/React.createElement(Box_Box.Box, {
      use: "ul",
