...
function useGetStates() {
  ...
  var isIdle = React.useMemo(function () {
    return !records.some(function (record) {
      return !record.isIdle;
    });
  }, [records]);
  var isPending = React.useMemo(function () {
    return records.some(function (record) {
      return record.isPending;
    });
  }, [records]);
  var isPendingSlow = React.useMemo(function () {
    return records.some(function (record) {
      return record.isPendingSlow;
    });
  }, [records]);
  var isResolved = React.useMemo(function () {
    return !records.some(function (record) {
      return !record.isResolved && !record.isIdle;
    });
  }, [records]);
  var isRejected = React.useMemo(function () {
    return records.some(function (record) {
      return record.isRejected;
    });
  }, [records]);
  var isReloading = React.useMemo(function () {
    return records.some(function (record) {
      return record.isReloading;
    });
  }, [records]);
  var isReloadingSlow = React.useMemo(function () {
    return records.some(function (record) {
...
exports.cache = cache;
exports.invocationTimestamps = invocationTimestamps;
exports.records = records;
exports.promises = promises;
exports.revalidators = revalidators;
exports.suspenders = suspenders;
...
exports.useLoads = useLoads;
exports.useDeferredLoads = useDeferredLoads;
exports.useGetStates = useGetStates;
