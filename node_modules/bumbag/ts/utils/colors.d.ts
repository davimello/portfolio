...
export declare function shade(scale: any, color: any): ({ backgroundColor, colorMode, theme, }?: {
    backgroundColor?: string;
    colorMode?: string;
    theme?: any;
}) => any;
export declare function tint(scale: any, color: any): ({ backgroundColor, colorMode, theme, }?: {
    backgroundColor?: string;
    colorMode?: string;
    theme?: any;
}) => any;
