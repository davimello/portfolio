...
import { HeadingThemeConfig } from '../types';
declare const _default: (overrides: HeadingThemeConfig) => {
    h1: {
        fontSize: string;
        shrinkScale: number;
        styles?: {
    ...
    defaultProps: {
        ...
        colorMode?: string;
        disabled?: boolean;
        overrides?: import("../types").ThemeConfig;
    ...
    variants?: import("../types").Variant<HeadingThemeConfig>;
    modes?: import("../types").Variant<HeadingThemeConfig>;
};
